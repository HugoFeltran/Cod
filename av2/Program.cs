...
var clientesRepository = new ClienteRepository(databaseConfig);
var pedidosRepository = new PedidoRepository(databaseConfig);
var itenspedidosRepository = new ItensPedidoRepository(databaseConfig);
var vendedoresRepository = new VendedorRepository(databaseConfig);
var produtosRepository = new ProdutoRepository(databaseConfig);
...
if (modelName == "Pedido")
{
    ...
    if (modelAction == "Inserir")
    {
        ...
        var pedido = new Pedido(codPedido, prazoEntrega, DateTime.Now, pedidoCodCliente, pedidoCodVendedor);
...
if (modelAction == "MostrarPedidosCliente")
    ...
    if (modelAction == "MostrarQuantidadesProdutosPedido")
    {
        Console.WriteLine("Mostrar Quantidades de Produtos Vendidos");
        Console.Write("Digite o Código do produto: ");
        var itempedidocodproduto = Convert.ToInt32(Console.ReadLine());
...
if (modelName == "ItensPedido")
{
    ...
    if (modelAction == "Inserir")
    {
        ...
        var itemPedido = new ItensPedido(codItemPedido, itempedidocodpedido, itempedidocodproduto, quantidade);
...
if (modelName == "Vendedor")
{
    ...
    if (modelAction == "Inserir")
    {
        ...
        var vendedor = new Vendedor(codVendedor, nome, salario, faixaComissao);
